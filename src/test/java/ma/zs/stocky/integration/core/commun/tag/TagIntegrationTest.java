...
public class TagIntegrationTest {
    ...
    String pathHappy = "src/test/java/ma/zs/stocky/integration/core/commun/tag/TagHappyTest.feature";
    String pathSad = "src/test/java/ma/zs/stocky/integration/core/commun/tag/TagSadTest.feature";
